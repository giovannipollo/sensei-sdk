...
uint32_t MAX86150_Red_get(void) { return red; }
// Funtion to get the PPG IR data
uint32_t MAX86150_IR_get(void) { return ir; }
...
void max86150_irq_callback(const struct device *dev, struct gpio_callback *cb, uint32_t pins) {
...
*/
uint8_t MAX86150_getINT1(void) { return MAX86150_readRegister8(MAX86150_INTSTAT1); }

uint8_t MAX86150_getINT2(void) { return MAX86150_readRegister8(MAX86150_INTSTAT2); }
...
void MAX86150_shutDown(void) { MAX86150_bitMask(MAX86150_SYSCONTROL, MAX86150_SHUTDOWN_MASK, MAX86150_SHUTDOWN); }

void MAX86150_wakeUp(void) { MAX86150_bitMask(MAX86150_SYSCONTROL, MAX86150_SHUTDOWN_MASK, MAX86150_WAKEUP); }
...
void MAX86150_setPulseAmplitudeRed(uint8_t amplitude) { MAX86150_writeRegister8(MAX86150_LED2_PULSEAMP, amplitude); }

void MAX86150_setPulseAmplitudeIR(uint8_t amplitude) { MAX86150_writeRegister8(MAX86150_LED1_PULSEAMP, amplitude); }

void MAX86150_setPulseAmplitudeProximity(uint8_t amplitude) {
  MAX86150_writeRegister8(MAX86150_LED_PROX_AMP, amplitude);
}

void MAX86150_setProximityThreshold(uint8_t threshMSB) { MAX86150_writeRegister8(MAX86150_PROXINTTHRESH, threshMSB); }
...
uint8_t MAX86150_getWritePointer(void) { return MAX86150_readRegister8(MAX86150_FIFOWRITEPTR); }

uint8_t MAX86150_getReadPointer(void) { return MAX86150_readRegister8(MAX86150_FIFOREADPTR); }

uint8_t MAX86150_checkOVF(void) { return MAX86150_readRegister8(MAX86150_FIFOOVERFLOW); }

void MAX86150_setPROXINTTHRESH(uint8_t val) { MAX86150_writeRegister8(MAX86150_PROXINTTHRESH, val); }

uint8_t MAX86150_readPartID(void) { return MAX86150_readRegister8(MAX86150_PARTID); }
...
void MAX86150_setup(uint8_t sampleAverage) {
  ...
  */
  if (sampleAverage == 1)
    MAX86150_setFIFOAverage(MAX86150_SAMPLEAVG_1);
  else if (sampleAverage == 2)
    MAX86150_setFIFOAverage(MAX86150_SAMPLEAVG_2);
  else if (sampleAverage == 4)
    MAX86150_setFIFOAverage(MAX86150_SAMPLEAVG_4);
  else if (sampleAverage == 8)
    MAX86150_setFIFOAverage(MAX86150_SAMPLEAVG_8);
  else if (sampleAverage == 16)
    MAX86150_setFIFOAverage(MAX86150_SAMPLEAVG_16);
  else if (sampleAverage == 32)
    MAX86150_setFIFOAverage(MAX86150_SAMPLEAVG_32);
  else
    MAX86150_setFIFOAverage(MAX86150_SAMPLEAVG_4);
...
uint32_t MAX86150_getFIFORed(void) { return sense.red[sense.tail]; }

uint32_t MAX86150_getFIFOIR(void) { return sense.IR[sense.tail]; }
...
enum MAX20303_PPG_function_t Get_PPG_Function(void) { return MAX20303_PPG_function; }

void Set_PPG_Function(enum MAX20303_PPG_function_t f) { MAX20303_PPG_function = f; }
